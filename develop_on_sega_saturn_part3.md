...
![Sequence Diagram showing trace byte flow]({{ '/assets/img/develop_on_sega_saturn_part3/trace-sequence.svg' | relative_url }})
...
![Kronos log output showing trace messages]({{ '/assets/img/develop_on_sega_saturn_part3/kronos-logs-display.png' | relative_url }})
...
![Kronos Cart/Memory settings with Development Extension]({{ '/assets/img/develop_on_sega_saturn_part3/kronos-cart-memory-development-extension-settings.png' | relative_url }})
...
![Mednafen log output showing trace messages]({{ '/assets/img/develop_on_sega_saturn_part3/mednafen-logs-display.png' | relative_url }})
...
Continue with hardware logging in Part 4:
