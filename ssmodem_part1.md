...
To do so, the Conexant modem must be modified by adding a low-cost step-up converter that uses USB 5 V and injects 9 V into the phone line.

## Safety Notice

- Do not connect this modified adapter to a live PSTN/public telephone line.
- Perform all tests with the modem disconnected from external phone wiring and telecom infrastructure.
- Verify the trace cut and polarity with a multimeter before powering the circuit.
- This is an at-your-own-risk hardware modification; incorrect wiring can damage equipment.
...
![BOM]({{ '/assets/img/ssmodem_part1/PXL_20250426_214222355.MP.png' | relative_url }})
...
![Conexant teardown]({{ '/assets/img/ssmodem_part1/PXL_20250426_214605849.MP.png' | relative_url }})
...
![Trace to Cut]({{ '/assets/img/ssmodem_part1/PXL_20240119_131417114.MP.png' | relative_url }})
<p style="text-align:center"><i>Trace to Cut</i></p>

Use a knife to carefully cut the trace. It should look like this once cut:

![Trace Cut]({{ '/assets/img/ssmodem_part1/2020_0101_010321_005.jpg' | relative_url }})
...
![JST Wires]({{ '/assets/img/ssmodem_part1/PXL_20250426_221529153.MP.jpg' | relative_url }})
<p style="text-align:center"><i>JST Wires</i></p>

First, solder one JST connector to the USB 5V power input:

![USB Power]({{ '/assets/img/ssmodem_part1/2020_0102_005120_005.jpg' | relative_url }})
<p style="text-align:center"><i>USB Power</i></p>

Then solder another connector near the previously cut trace to inject the 9V:

![Power Line Injector Entry Points]({{ '/assets/img/ssmodem_part1/2020_0101_013049_005.jpg' | relative_url }})
...
![Coating example with silicone under UV light]({{ '/assets/img/ssmodem_part1/2020_0102_020225_005.jpg' | relative_url }})
...
![Board Configurations]({{ '/assets/img/ssmodem_part1/2020_0101_013807_005.jpg' | relative_url }})
<p style="text-align:center"><i>Step-Up Converter Configuration</i></p>

After adjusting, confirm:

![Board Configured]({{ '/assets/img/ssmodem_part1/2020_0101_000424_005.jpg' | relative_url }})
...
![Board Configured]({{ '/assets/img/ssmodem_part1/2020_0102_033201_004.jpg' | relative_url }})
<p style="text-align:center"><i>Step-Up Converter input wiring</i></p>

![Wiring diagram]({{ '/assets/img/ssmodem_part1/1_diagram.png' | relative_url }})
...
Use heat shrink tubing to cover the twisted legs. Then, solder the JST cable to both the step-up converter positive pad and the twisted legs:

![Board Configured]({{ '/assets/img/ssmodem_part1/2020_0118_222140_007.jpg' | relative_url }})
<p style="text-align:center"><i>Step-Up JST cable assembly</i></p>

Optional: bridge both negative pads using a short wire or the resistor leg for additional mechanical stability. This is not required for core function.

![Step-Up grounding]({{ '/assets/img/ssmodem_part1/2020_0118_222437_008.jpg' | relative_url }})
...
![Step-Up board coating]({{ '/assets/img/ssmodem_part1/PXL_20250628_174654179.jpg' | relative_url }})
...
![Parts]({{ '/assets/img/ssmodem_part1/PXL_20250628_190647493.jpg' | relative_url }})
<p style="text-align:center"><i>Parts</i></p>

Connect the step-up converter to the modem using the JST connectors. Once connected, it is time to test.

A good first test is to inject 5 V into the USB port and confirm that the step-up board powers on. Then, use a multimeter to read the current draw. During my test, I measured 4.85 V at 0.07 A.

![Validation]({{ '/assets/img/ssmodem_part1/PXL_20250628_191111627.jpg' | relative_url }})
...
![Folding all within the case]({{ '/assets/img/ssmodem_part1/PXL_20250628_194322102.jpg' | relative_url }})
<p style="text-align:center"><i>Folding everything within the case</i></p>

## Result

![Result]({{ '/assets/img/ssmodem_part1/PXL_20250628_194648052.MP.jpg' | relative_url }})
